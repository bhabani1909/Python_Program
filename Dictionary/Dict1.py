...
key is immutable (it can be float/int/string but not list as it is mutable)
value is mutable
dict  is mutable

insertion order not preserved. (like set)
...
o/p:
{1: 'A', 2: 'E', 5: 'C', 4: 10} #2 is reassigned from B to E
